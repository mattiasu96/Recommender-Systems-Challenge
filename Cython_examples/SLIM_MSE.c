 ...
 */
      ...
      } else if (unlikely(__pyx_t_17 >= __pyx_v_item_item_S.shape[0])) __pyx_t_12 = 0;
      if (__pyx_t_18 < 0) {
        __pyx_t_18 += __pyx_v_item_item_S.shape[1];
        if (unlikely(__pyx_t_18 < 0)) __pyx_t_12 = 1;
      } else if (unlikely(__pyx_t_18 >= __pyx_v_item_item_S.shape[1])) __pyx_t_12 = 1;
      if (unlikely(__pyx_t_12 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_12);
        __PYX_ERR(0, 45, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_item_item_S.data + __pyx_t_17 * __pyx_v_item_item_S.strides[0]) ) + __pyx_t_18 * __pyx_v_item_item_S.strides[1]) )) += (__pyx_v_prediction_error * __pyx_v_learning_rate);
 ...
 */
    __pyx_t_19 = ((__Pyx_mod_long((__pyx_v_sample_num + 1), 0x1388) == 0) != 0);
    if (__pyx_t_19) {
 ...
 */
      ...
      #endif
      {
        __pyx_t_20 = PyTuple_New(4+__pyx_t_12); if (unlikely(!__pyx_t_20)) __PYX_ERR(0, 51, __pyx_L1_error)
        ...
        PyTuple_SET_ITEM(__pyx_t_20, 1+__pyx_t_12, __pyx_v_elapsed_time);
        ...
        PyTuple_SET_ITEM(__pyx_t_20, 3+__pyx_t_12, __pyx_v_samples_per_second);
        __pyx_t_4 = 0;
        __pyx_t_3 = 0;
        __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_20, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 51, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
