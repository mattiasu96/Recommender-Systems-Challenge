 ...
 */
    ...
    __Pyx_DECREF(__pyx_t_35); __pyx_t_35 = 0;
    __pyx_t_35 = PyFloat_FromDouble((__pyx_v_loss / __pyx_v_sample_num)); if (unlikely(!__pyx_t_35)) __PYX_ERR(0, 87, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_35);
    __pyx_t_33 = NULL;
    __pyx_t_6 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_36); __pyx_t_36 = 0;
  __pyx_t_36 = PyFloat_FromDouble(__pyx_v_loss); if (unlikely(!__pyx_t_36)) __PYX_ERR(0, 89, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_36);
