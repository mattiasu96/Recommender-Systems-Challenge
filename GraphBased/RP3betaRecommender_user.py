...
class RP3betaRecommender_user(BaseUserSimilarityMatrixRecommender):
    """ RP3beta recommender """

    RECOMMENDER_NAME = "RP3betaRecommender_user"

    def __init__(self, URM_train, verbose = True):
        super(RP3betaRecommender_user, self).__init__(URM_train, verbose = verbose)
