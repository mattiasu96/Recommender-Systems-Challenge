...
class P3alphaRecommender_user(BaseUserSimilarityMatrixRecommender):
    """ P3alpha recommender """

    RECOMMENDER_NAME = "P3alphaRecommender_user"

    def __init__(self, URM_train, verbose = True):
        super(P3alphaRecommender_user, self).__init__(URM_train, verbose = verbose)
