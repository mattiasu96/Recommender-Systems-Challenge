...
class ItemKNNScoresHybrid5Recommender(BaseItemSimilarityMatrixRecommender):
    ...
    def __init__(self, URM_train, Recommender_1, Recommender_2, Recommender_3, Recommender_4, Recommender_5):
        super(ItemKNNScoresHybrid5Recommender, self).__init__(URM_train)
    ...
    def fit(self, first = 0.5, second = 0.5, third = 0.5, forth = 0.5, fifth = 0.5):
        self.first = first    
        self.second = second
        self.third = third
        self.forth = forth
    ...
    def _compute_item_score(self, user_id_array, items_to_compute):
        ...
        item_weights = item_weights_1*self.first + item_weights_2*self.second + item_weights_3*self.third + item_weights_4*self.forth + item_weights_5*self.fifth
